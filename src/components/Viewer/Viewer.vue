...
<i18n>
{
	"en": {
		"Viewer": {
			"NoContent": "No article selected. Click 'Open' button in the table to view an article."
		}
	},
	"ja": {
		"Viewer": {
			"NoContent": "記事が選択されていません。テーブルの「Open」ボタンをクリックして記事を表示してください。"
		}
	}
}
</i18n>
...
<style scoped>
/* CSS adapted from MyMarkdownCSS: https://github.com/konbraphat51/MyMarkdownCSS */
...
/* MyMarkdownCSS styles - scoped to markdown-body */
.markdown-body {
	--base-size-4: 0.25rem;
	--base-size-8: 0.5rem;
	--base-size-16: 1rem;
...
.markdown-body {
	...
	font-family: -apple-system, BlinkMacSystemFont, "Yu Gothic", "Meiryo",
		sans-serif, "Segoe UI", "Noto Sans", Helvetica, Arial, "Apple Color Emoji",
		"Segoe UI Emoji";
	font-size: 16px;
	line-height: 1.5;
...
.markdown-body h3 {
	font-size: 1.5rem;
	padding: 0 0.2rem;
	border-bottom: solid 2px #81d498;
	width: fit-content;
	margin: 0 0 0.5em;
}
...
.markdown-body alert > :first-child {
	margin-top: 0;
}
...
.markdown-body alert alert-title {
	display: flex;
