...
- used for:
  ...
  - RPG
  - simulation game
- perfect top-view: "Zebius", "Monaco GP"
- "Zelda"

  - objects is shown by side-view
    - Link's face is shown, not top of the head
  - videogame is **a traditional symbols**
  - not aiming for real-space replication
...
- able to travel anywhere in the map you can see (unless blocked)
  - better for **exploration-type** game
...
- gained **height**
  - and **gravity**
- lose **z-axis**, **thickness**
- usage of gravity
  - "Gradius" (Konami)
    - no gravity
  - "Super Mario Bros."
    - has gravity
    - character often positioned lower in the screen
      - need jumping, floating objects to use the entire screen

#### rear-view

- typical method to make fake-3D
- masterpieces of 3D games
  - "Poll Position" (Namco)
  - "Hang On" (Sega)
  - "Space Harier" (Sega)
- Third-person but not First-person
  - the main character is shown or not

#### Quater-view

- isometric
- 3d for game is just a decoration
  - wrong as a real 3D

#### first-person view

- originated from "Maze War" (NASA)
- better for maze
- existence if **off-screen**
  - there are something happening even the backside of the player
